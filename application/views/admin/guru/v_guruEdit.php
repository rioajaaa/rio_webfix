            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="input-group input-group-outline mb-3">
                        <input type="text" value="<?= $guru['nama_pengajar']; ?>" class="form-control" id="nama_pengajar" name="nama_pengajar" placeholder="Nama Pengajar">
                        <?= form_error('nama_pengajar', '<small class="text-danger pl-3 row col-lg-12">', '</small>'); ?>
                    </div>
                    <div class="input-group input-group-outline mb-3">
                        <input type="text" value="<?= $guru['noin_pengajar']; ?>" class="form-control" id="noin_pengajar" name="noin_pengajar" placeholder="No Induk">
                    ...
                    <div class="input-group input-group-outline mb-3">
                        <input type="text" value="<?= $guru['jabatan_pengajar']; ?>" class="form-control" id="jabatan_pengajar" name="jabatan_pengajar" placeholder="Jabatan Pengajar">
                        <?= form_error('jabatan_pengajar', '<small class="text-danger pl-3 row col-lg-12">', '</small>'); ?>
                    </div>
                    <div class="input-group input-group-outline mb-3">
                        <img src="<?= base_url('assets/img/ponpes/') . $guru['foto']; ?>" style="width: 100px; margin-bottom: 5px;" class="img-thumbnail">
