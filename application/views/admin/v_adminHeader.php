...
<head>
    ...
    <link href="<?= base_url('assets/') ?>img/ponpes/al-amin-head.png" rel="icon">
...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?= base_url('Admin') ?>" target="">
                <img src="<?= base_url('assets/') ?>img/ponpes/al-amin-head.png" class="navbar-brand-img h-100" alt="main_logo" />
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?= base_url('Sejarah') ?>">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
